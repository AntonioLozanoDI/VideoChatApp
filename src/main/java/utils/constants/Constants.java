...
public class Constants {
	...
	public static final class FilePaths {
		...
		public static final String FXML = Constants.OSIndependentPath("application", "view", "fxml");

		public static final String CSS = "styles";

		public static final String Properties = Constants.OSIndependentPath("cfg", "properties");
		...
		public static final String logs = Constants.OSIndependentPath("tmp", "logs");
	...
	public static String OSIndependentPath(String... dirs) {
		...
		int i = 0;
		for (String dir : dirs) {
			sb.append(dir).append( ++i == dirs.length ? "" : "/" );
		}
		return sb.toString();
	}
}
