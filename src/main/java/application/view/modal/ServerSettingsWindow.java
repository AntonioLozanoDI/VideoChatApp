...
import application.controller.fxml.ServerSettingsController;
...
public class ServerSettingsWindow extends ApplicationModal {
	...
	protected void buildModal(Stage owner) {
		...
		try {
			...
			controller = (ServerSettingsController) loader.getController();
