...
import application.controller.fxml.RegisterUserController;
...
public class RegisterUserWindow extends ApplicationModal {
	...
	protected void buildModal(Stage owner) {
		...
		try {
			...
			resource = ApplicationResourceProvider.getFXMLFile(Constants.Files.FXML.RegisterUserWindow).toURL();
