...
import application.controller.fxml.ContactFormController;
...
public class ContactForm extends ApplicationModal {
	...
	protected void buildModal(Stage owner) {
		...
		try {
			...
			resource = ApplicationResourceProvider.getFXMLFile(Constants.Files.FXML.ContactForm).toURL();
			...
			controller = (ContactFormController) loader.getController();
	...
	public ContactFormController getController() {
		return controller;
	}
}
